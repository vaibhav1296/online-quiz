    ...
    systemQueryObject
      ...
      .then((userRoleObject) => {
        ...
        if (roleName === role) {
          ...
          // throw onlineQuizError("The email is invalid",400)
          return reject(
            onlineQuizError("This email is not valid for provided role", 400)
          );
        }
      })
      .catch((err) => {
